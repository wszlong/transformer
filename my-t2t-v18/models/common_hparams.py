...
def transformer_params():
  ...
  return tf.contrib.training.HParams(
      ...
      shared_embedding_and_softmax_weights_source = int(True),
      shared_embedding_and_softmax_weights_target = int(True),
      pos = "timing",
      ...
      vocabulary = {
          "inputs": text_reader.TokenTextEncoder(vocab_filename="/data/lz/t2t/MY-T2T/data/vocab.bpe.zh"),
          "targets": text_reader.TokenTextEncoder(vocab_filename="/data/lz/t2t/MY-T2T/data/vocab.bpe.en"),
      },
  )

def transformer_params_base():
  """A set of basic hyperparameters."""
