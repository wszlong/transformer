    ...
    with tf.gfile.GFile(source_path, mode="r") as source_file:
        with tf.gfile.GFile(target_path, mode="r") as target_file:
            ...
            while source and target:
                source_ints = token_vocab_src.encode(source.strip(), replace_oov="UNK") + eos_list  ## 0:pad, 1:eos, 2:UNK
                target_ints = token_vocab_tgt.encode(target.strip(), replace_oov="UNK") + eos_list
